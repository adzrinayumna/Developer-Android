package id.ac.e020320033.homework_73_powerreceiver;
...
public class CustomReceiver extends BroadcastReceiver {
    ...
    private static final String EXTRA_RANDOM_NUMBER
            = "id.ac.e020320033.homework_73_powerreceiver.RANDOM_NUMBER";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intentAction != null) {
            ...
            Toast.makeText(context, toastMessage +
                    " Square of the number is " + number * number, Toast.LENGTH_LONG).show();
        }
    }
}